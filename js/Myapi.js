 ...
 * @Last Modified time: 2018-08-27 11:14:43
*/
...
function Myapi(){  //构造函数
    ...
    this.JSON = {
        ...
        indexChange: function(obj,l,i){   //改变计数点
            ...
            obj.find('li').eq(this.index).addClass('active').siblings().removeClass('active');
        },
        ...
        cut : function(imgObj,C,w,d,pUL,l){   //左右切换函数
            ...
            C.css('top',Math.ceil((imgObj.height() - C.height()) / 1.5));
